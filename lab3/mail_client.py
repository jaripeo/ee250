...
SERVER = 'http://pi@daverodr.local:5000'
...
def get_inbox(recipient: str) -> None:
    """
    Retrieves all incoming emails for the specified recipient by making a GET request to the /mail/inbox/<recipient> endpoint.
    The response contains a list of mail entries addressed to the recipient.
    
    Args:
        recipient (str): The recipient whose inbox will be retrieved

    Returns:
        bool: True if the mail was successfully retrieved from the recipient's inbox, False otherwise
    """
...
def get_sent(sender: str) -> None:
    """
    Retrieves all emails sent by the specified sender by making a GET request to the /mail/sent/<sender> endpoint.
    The response contains a list of mail entries sent by the sender.

    Args:
        sender (str): The sender whose sent mail will be retrieved

    Returns:
        bool: True if the mail was successfully retrieved from the sender's inbox, False otherwise
    """
...
def get_mail(mail_id: str) -> None:
    """
    Retrieves a specific email by its unique mail ID by making a GET request to the /mail/<mail_id> endpoint.
    The response contains the details of the email with the given ID.

    Args:
        mail_id (str): The unique identifier of the email to retrieve

    Returns:
        bool: True if the mail was successfully retrieved from the specific mail_id, False otherwise
    """
...
def delete_mail(mail_id: str) -> None:
    """
    Deletes a specific email by its unique mail ID by making a DELETE request to the /mail/<mail_id> endpoint.
    The response contains the result of the deletion operation.

    Args:
        mail_id (str): The unique identifier of the email to delete

    Returns:
        bool: True if the mail was successfully deleted, False otherwise
    """
