...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("daverodr/ipinfo/ip")
    client.subscribe("daverodr/ipinfo/date") 
    client.subscribe("daverodr/ipinfo/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("daverodr/ipinfo/ip", on_message_from_ipinfo)
    client.message_callback_add("daverodr/ipinfo/date", on_message_from_date)
    client.message_callback_add("daverodr/ipinfo/time", on_message_from_time)
...
#Custom message callback for IP address
def on_message_from_ipinfo(client, userdata, message):
   print("IP Address Callback - Received IP: " + message.payload.decode())

#Custom message callback for date
def on_message_from_date(client, userdata, message):
   print("Date Callback - Received Date: " + message.payload.decode())

#Custom message callback for time  
def on_message_from_time(client, userdata, message):
   print("Time Callback - Received Time: " + message.payload.decode())
